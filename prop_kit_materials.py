...
def create_material(name="stone_mat", color=(0.75, 0.72, 0.65), material_type="lambert"):
  """
  Create a Lambert shader with the given color and name. The shading group is named "<name>_SG" 
  and is wired up internally; callers do not need to track it -- assign_material() looks it up
